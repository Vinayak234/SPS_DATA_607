...
* __Data Source:__ Lottery Mega Millions Winning Numbers Repository [Source](https://catalog.data.gov/dataset/lottery-mega-millions-winning-numbers-beginning-2002)
...
```
## Result
### Most five winning numbers and Mega Ball are **`r five_number[1:5]`    AND   `r p_mega`**
...
### Ratio of heart disease between males and females is `r ratio` : 1 
